    ...
    return (
        <div className='flex flex-row bg-gray-200 py-20'>
            <div className="flex flex-col " >
                <h4 className=' md:mx-36 mx-4 font-medium text-left uppercase fontcolor lg:text-[35px] text-[24px] leading-[36px] md:py-8 py-4'>Equipo</h4>
                        ...
                        <div className='text-center w-full flex flex-col lg:mb-[50px] mb-[20px]' key={item.id}>
                            <div className="">
                                <div className="flex flex-col mt-[50px] lg:text-left md:w-[700px]">
                                    <div className="md:mx-36 mx-4 md:space-y-6 space-y-4 fontcolor">
